...
while True:
    ...
    if cmd == "about":
        print("About")
        print("PicoOS 1.0 Dev 11")
        print("Made by Crunch Media Group Software")
        print("This PicoPC belongs to someone" + ".")
        print("Report any issues to computercrunchnz+picoos1@gmail.com")
    elif cmd == "update":
        print("Update")
        ...
        print("'temp-taker' - Take the temperature 9 #times every _ seconds and save to a file. It is spread across 3 files.")
